...
<section id="projects">
    <div class="projects container">
      ...
      <div class="col-12">
        ...
        <p style="font-size: 2.4rem; font-weight: 400; margin-bottom: 30px;">Berikut beberapa pameran foto MPF Analog :</p>
        <p style="font-size: 3.2rem; font-weight: 500; text-align: center; margin-bottom: 25px;">1. “KEGALIBAN” oleh Angkatan XI</p>
        <div class="row">
          <div class="col-7">
  ...
  <section id="atindriya" style="background: #29323c;">
    <div class="atindriya container">
      <div class="col-12">
        ...
        <p style="font-size: 3.2rem; font-weight: 500; text-align: center; margin-bottom: 25px;color: white;">2. “ATINDRIYA” oleh Angkatan XI</p>
        <div class="row">
          <div class="col-7">
